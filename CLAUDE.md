...
**Responder mode is a labelled demo toggle, not a role system.** It lives on the nearby-SOS screen where the artboard already has "Magparehistro bilang responder", and its subtext says in as many words that the barangay activates this in the real product. Day 10 is the real role work.
