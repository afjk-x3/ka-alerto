 ...
 * (OfflineMapPack, HOME_REGION_NAME) is built around it at registration, so it renders
 * offline. A home inside the demo area returns null on purpose — demo phones must open
 * exactly where they always have, or the scripted demo stops being repeatable.
 *
